...
INSERT INTO language_learning_app.cards VALUES
    (NULL, 1, 1, 'desayuno', 'breakfast', 2, "(m)", 60),
    (NULL, 1, 1, 'cena', 'dinner', 2, "(f)", 90),
    (NULL, 1, 2, 'Morgen', 'morning', 2, '(m)', 60),
    (NULL, 1, 2, 'Abend', 'evening', 2, '(m)', 90);
